...
document.querySelector('.text-block-29').addEventListener('click', () => {
    ...
    setTimeout(() => {
        window.location.href = "https://how-to-leave-town.webflow.io/how-to-leave-town-home";
...
setTimeout(() => {
  animateCountUp(document.getElementById("countyo"), targetValue, duration, cubicBezier);
}, delay);
  document
